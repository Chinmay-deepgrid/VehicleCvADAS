...
def set_color(color):
    """
    Cross-platform console color setting function.
    
    Args:
        color (str): Color to set. Supported on Windows and some Unix terminals.
    """
    if platform.system() == 'Windows':
        ...
        if color == 0x0007:  # WHITE
            print(color_map['WHITE'], end='')
        elif color == 0x01:  # BLUE
            print(color_map['BLUE'], end='')
        elif color == 0x02:  # GREEN
            print(color_map['GREEN'], end='')
        elif color == 0x04:  # RED
            print(color_map['RED'], end='')
        elif color == 0x06:  # YELLOW
            print(color_map['YELLOW'], end='')
